...
function fetchTopStocks() {
  fetch(
    "https://www.alphavantage.co/query?function=SECTOR&apikey=EOXWKDCTNTBCXSAH"
  )
...
function fetchStockData(symbol) {
  ...
  fetch(
    `https://www.alphavantage.co/query?function=GLOBAL_QUOTE&symbol=${symbol}&apikey=EOXWKDCTNTBCXSAH`
  )
    .then((response) => response.json())
    .then((data) => {
